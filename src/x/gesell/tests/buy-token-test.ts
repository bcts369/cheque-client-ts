...
async function buyTokenTest(sdk: CosmosSDK, denomPrefix: string, params: BuyTokenReq) {
    try {
        const tx = await Gesell.buyToken(sdk, denomPrefix, params);
...
buyTokenTest(sdk, denomPrefix, params);